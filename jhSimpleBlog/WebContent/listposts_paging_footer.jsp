...
<form action="Posts" method="get" id="navigatorForm">
	...
	<a href="Posts?method=list&pageNumber=1">首页</a> 
	<c:if test="${pageNumber>1}">
		<a href="Posts?method=list&pageNumber=${pageNumber-1}">上一页</a>
	</c:if> 
	...
	<c:if test="${pageNumber<totalPages}">
		<a href="Posts?method=list&pageNumber=${pageNumber+1}">下一页</a>
	</c:if> 
	<a href="Posts?method=list&pageNumber=${totalPages}">末页</a>
</form>
