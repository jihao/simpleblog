...
//FCKCommands.RegisterCommand( 'HighLighter', new FCKDialogCommand('HighLighter', '插入语法高亮代码' ,FCKConfig.PluginsPath + 'highlighter/highlighter.html', 600, 540 ) ) ;
...
// var oHighLighterItem		= new FCKToolbarButton( 'HighLighter', '插入语法高亮代码' ) ;
